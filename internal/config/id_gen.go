...
type IDGenConfig struct {
	...
	AttemptPrefix     string `yaml:"attempt_prefix" env:"IDGEN_ATTEMPT_PREFIX" desc:"Prefix for attempt IDs, prepended with underscore (e.g., 'att_123'). Default: empty (no prefix)" required:"N"`
}
