...
type DestinationWebhookConfig struct {
	...
	HeaderPrefix                  string `yaml:"header_prefix" env:"DESTINATIONS_WEBHOOK_HEADER_PREFIX" desc:"Prefix for custom headers added to webhook requests (e.g., 'X-MyOrg-'). Only applies to 'default' mode." required:"N"`
