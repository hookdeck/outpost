...
func TestPublisherExpiration(t *testing.T) {
	...
	assert.Equal(t, id1, id2, "Expected same publisher instance before expiration")
	...
	assert.NotEqual(t, id1, id3, "Expected different publisher instance after expiration")
}
