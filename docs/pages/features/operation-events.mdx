...
Operation events are delivered on a best-effort basis with up to 3 retries and exponential backoff (100ms, 200ms, 400ms). Consumers should use the `id` field for deduplication.
