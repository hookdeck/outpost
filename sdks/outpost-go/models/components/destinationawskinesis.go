...
func (d *DestinationAWSKinesis) GetFilter() optionalnullable.OptionalNullable[map[string]any] {
	if d == nil {
		return nil
	}
	return d.Filter
...
func (d *DestinationAWSKinesis) GetDeliveryMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
...
func (d *DestinationAWSKinesis) GetMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
	return d.Metadata
...
func (d *DestinationAWSKinesis) GetTargetURL() optionalnullable.OptionalNullable[string] {
	if d == nil {
		return nil
	}
	return d.TargetURL
