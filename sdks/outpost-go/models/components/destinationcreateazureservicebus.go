...
func (d *DestinationCreateAzureServiceBus) GetCreatedAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.CreatedAt
...
func (d *DestinationCreateAzureServiceBus) GetUpdatedAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.UpdatedAt
...
func (d *DestinationCreateAzureServiceBus) GetDisabledAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.DisabledAt
