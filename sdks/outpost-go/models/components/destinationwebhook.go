...
func (d *DestinationWebhook) GetFilter() optionalnullable.OptionalNullable[map[string]any] {
	if d == nil {
		return nil
	}
	return d.Filter
...
func (d *DestinationWebhook) GetDeliveryMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
...
func (d *DestinationWebhook) GetMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
	return d.Metadata
...
func (d *DestinationWebhook) GetTargetURL() optionalnullable.OptionalNullable[string] {
	if d == nil {
		return nil
	}
	return d.TargetURL
