...
func (d *DestinationAWSSQS) GetFilter() optionalnullable.OptionalNullable[map[string]any] {
	if d == nil {
		return nil
	}
	return d.Filter
...
func (d *DestinationAWSSQS) GetDeliveryMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
...
func (d *DestinationAWSSQS) GetMetadata() optionalnullable.OptionalNullable[map[string]string] {
	if d == nil {
		return nil
	}
	return d.Metadata
...
func (d *DestinationAWSSQS) GetTargetURL() optionalnullable.OptionalNullable[string] {
	if d == nil {
		return nil
	}
	return d.TargetURL
