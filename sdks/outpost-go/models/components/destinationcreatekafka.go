...
func (d *DestinationCreateKafka) GetCreatedAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.CreatedAt
...
func (d *DestinationCreateKafka) GetUpdatedAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.UpdatedAt
...
func (d *DestinationCreateKafka) GetDisabledAt() optionalnullable.OptionalNullable[time.Time] {
	if d == nil {
		return nil
	}
	return d.DisabledAt
