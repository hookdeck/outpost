...
// Health - This endpoint is only available for **self-hosted** Outpost deployments. Managed Outpost health is monitored by Hookdeck.
type Health struct {
	rootSDK          *Outpost
...
func newHealth(rootSDK *Outpost, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Health {
	return &Health{
		rootSDK:          rootSDK,
