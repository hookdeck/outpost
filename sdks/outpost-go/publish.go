...
func newPublish(rootSDK *Outpost, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Publish {
	return &Publish{
		rootSDK:          rootSDK,
...
func (s *Publish) Event(ctx context.Context, request components.PublishRequest, opts ...operations.Option) (*operations.PublishEventResponse, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"401", "403", "404", "407", "408", "409", "413", "414", "415", "422", "429", "431", "4XX", "500", "501", "502", "503", "504", "505", "506", "507", "508", "510", "511", "5XX"}, httpRes.StatusCode) {
