...
### `models.GetAttemptMetricsMeasuresEnum1`

```python
value: models.GetAttemptMetricsMeasuresEnum1 = /* values here */
```

### `List[models.GetAttemptMetricsMeasuresEnum2]`

```python
value: List[models.GetAttemptMetricsMeasuresEnum2] = /* values here */
```
