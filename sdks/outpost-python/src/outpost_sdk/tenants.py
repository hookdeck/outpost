...
class Tenants(BaseSDK):
    ...
    def list_tenants(
        ...
        *,
        ...
        order_by: Optional[
            models.ListTenantsOrderBy
        ] = models.ListTenantsOrderBy.CREATED_AT,
        direction: Optional[models.ListTenantsDir] = models.ListTenantsDir.DESC,
        ...
        **Requirements:** This endpoint requires Redis with RediSearch module (e.g., `redis/redis-stack-server`).
        ...
        :param created_at_gte: Filter tenants created at or after this time (RFC3339 or YYYY-MM-DD format).
        :param created_at_lte: Filter tenants created at or before this time (RFC3339 or YYYY-MM-DD format).
