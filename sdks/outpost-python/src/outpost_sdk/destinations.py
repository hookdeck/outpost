...
class Destinations(BaseSDK):
    ...
    def list_attempts(
        ...
        *,
        ...
        status: Optional[models.ListTenantDestinationAttemptsStatus] = None,
        topic: Optional[
            Union[
                models.ListTenantDestinationAttemptsTopic,
                models.ListTenantDestinationAttemptsTopicTypedDict,
            ]
        ] = None,
        ...
        include: Optional[
            Union[
                models.ListTenantDestinationAttemptsInclude,
                models.ListTenantDestinationAttemptsIncludeTypedDict,
            ]
        ] = None,
        order_by: Optional[
            models.ListTenantDestinationAttemptsOrderBy
        ] = models.ListTenantDestinationAttemptsOrderBy.TIME,
        direction: Optional[
            models.ListTenantDestinationAttemptsDir
        ] = models.ListTenantDestinationAttemptsDir.DESC,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        req = self._build_request(
            method="GET",
            path="/tenants/{tenant_id}/destinations/{destination_id}/attempts",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.ListTenantDestinationAttemptsGlobals(
                tenant_id=self.sdk_configuration.globals.tenant_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="listTenantDestinationAttempts",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    def get_attempt(
        ...
        *,
        ...
        include: Optional[
            Union[
                models.GetTenantDestinationAttemptInclude,
                models.GetTenantDestinationAttemptIncludeTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.GetTenantDestinationAttemptRequest(
            tenant_id=tenant_id,
            destination_id=destination_id,
        ...
        req = self._build_request(
            method="GET",
            path="/tenants/{tenant_id}/destinations/{destination_id}/attempts/{attempt_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetTenantDestinationAttemptGlobals(
                tenant_id=self.sdk_configuration.globals.tenant_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getTenantDestinationAttempt",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
