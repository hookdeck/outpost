...
class DestinationAWSKinesisType(str, Enum):
    r"""Type of the destination."""

    AWS_KINESIS = "aws_kinesis"


class DestinationAWSKinesisTypedDict(TypedDict):
    id: str
    ...
    r"""A human-readable representation of the destination target (Kinesis stream name). Read-only."""
    target_url: NotRequired[Nullable[str]]
    r"""A URL link to the destination target (AWS Console link to the stream). Read-only."""


class DestinationAWSKinesis(BaseModel):
    id: str
    r"""Control plane generated ID or user provided ID for the destination."""
