...
class PublishRequestTypedDict(TypedDict):
    ...
    id: NotRequired[str]
    r"""Optional. A unique identifier for the event. If not provided, a ID will be generated."""
    ...
    r"""Optional. Custom timestamp for the event. If not provided, defaults to the current time."""
