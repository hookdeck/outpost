...
class DestinationKafkaType(str, Enum):
    r"""Type of the destination."""

    KAFKA = "kafka"


class DestinationKafkaTypedDict(TypedDict):
    id: str
    r"""Control plane generated ID or user provided ID for the destination."""
    type: DestinationKafkaType
    r"""Type of the destination."""
    ...
    config: KafkaConfigTypedDict
    credentials: KafkaCredentialsTypedDict
    ...
    r"""A human-readable representation of the destination target (broker and topic). Read-only."""
    target_url: NotRequired[Nullable[str]]
    r"""A URL link to the destination target. Read-only."""


class DestinationKafka(BaseModel):
    id: str
    r"""Control plane generated ID or user provided ID for the destination."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["filter", "delivery_metadata", "metadata", "target", "target_url"]
        )
        nullable_fields = set(
...
try:
    DestinationKafka.model_rebuild()
except NameError:
    pass
