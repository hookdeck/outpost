...
class DestinationCreateKafkaType(str, Enum):
    r"""Type of the destination. Must be 'kafka'."""

    KAFKA = "kafka"


class DestinationCreateKafkaTypedDict(TypedDict):
    type: DestinationCreateKafkaType
    r"""Type of the destination. Must be 'kafka'."""
...
class DestinationCreateKafka(BaseModel):
    type: DestinationCreateKafkaType
    r"""Type of the destination. Must be 'kafka'."""
...
try:
    DestinationCreateKafka.model_rebuild()
except NameError:
    pass
