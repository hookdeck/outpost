...
class DestinationGCPPubSubType(str, Enum):
    r"""Type of the destination."""

    GCP_PUBSUB = "gcp_pubsub"


class DestinationGCPPubSubTypedDict(TypedDict):
    id: str
    ...
    r"""A human-readable representation of the destination target (project/topic). Read-only."""
    target_url: NotRequired[Nullable[str]]
    r"""A URL link to the destination target (GCP Console link to the topic). Read-only."""


class DestinationGCPPubSub(BaseModel):
    id: str
    r"""Control plane generated ID or user provided ID for the destination."""
...
try:
    DestinationGCPPubSub.model_rebuild()
except NameError:
    pass
