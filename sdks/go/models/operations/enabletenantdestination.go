...
type EnableTenantDestinationSecurity struct {
...
func (o *EnableTenantDestinationSecurity) GetAdminAPIKey() *string {
	if o == nil {
		return nil
	}
...
func (o *EnableTenantDestinationSecurity) GetTenantJwt() *string {
	if o == nil {
		return nil
	}
	return o.TenantJwt
