...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTenantDestinationTypeSchemaRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/{tenant_id}/destination-types/{type}")(pathParams);
