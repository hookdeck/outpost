 ...
 */
export function configurationUpdateManagedConfig(
  client: OutpostCore,
  request: components.ManagedConfig,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ManagedConfig,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.ManagedConfig$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ManagedConfig$inboundSchema),
