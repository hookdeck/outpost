...
> {
  const input: operations.GetTenantDestinationAttemptRequest = {
    tenantId: tenantId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetTenantDestinationAttemptRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    attempt_id: encodeSimple("attempt_id", payload.attempt_id, {
      explode: false,
