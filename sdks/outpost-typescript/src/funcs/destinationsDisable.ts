 ...
 */
export function destinationsDisable(
  client: OutpostCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisableTenantDestinationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/{tenant_id}/destinations/{destination_id}/disable")(
    pathParams,
  );
