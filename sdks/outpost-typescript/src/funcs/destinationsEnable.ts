 ...
 */
export function destinationsEnable(
  client: OutpostCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EnableTenantDestinationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/{tenant_id}/destinations/{destination_id}/enable")(
    pathParams,
  );
